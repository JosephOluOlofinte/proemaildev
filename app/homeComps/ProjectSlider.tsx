      ...
      <section className="w-[85%] my-0 mx-auto py-16">
        ...
        <div className="text-center mt-12">
          <Button
            ...
            inUrl="/projects"
            className="border-2 border-indigo-600 text-indigo-600 px-6 py-3 font-medium hover:bg-indigo-600 hover:text-white"
          />
        </div>
      </section>
    </Fragment>
